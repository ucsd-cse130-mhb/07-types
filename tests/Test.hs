...
unit sc = testGroup "NANO"
  ...
  , scoreTest ( uncurry (Nano.extendSubst [("a", TInt)])
               ...
               , 2
               , "part 1b test 10" )
  , scoreTest ( uncurry (Nano.extendSubst [("a", Nano.list "b")])
               , ("b", TBool)
               , [("b", TBool), ("a", Nano.list TBool)]
               , 2
               , "part 1b test 11" )
  , scoreTest ( uncurry (Nano.extendSubst [("a", TInt)])
               , ("b", (TList (TVar "a")))
  ...
  , failTest  ( Nano.stSub . uncurry (Nano.unify Nano.initInferState)
              ...
              , 3
              , "unify 4" )
  , scoreTest ( sort . Nano.stSub . uncurry (Nano.unify Nano.initInferState)
              , ("a" Nano.:=> Nano.TInt, Nano.TBool Nano.:=> "b")
              , [("a", Nano.TBool), ("b", Nano.TInt)]
              , 3
              , "unify 5" )
  , failTest  ( Nano.stSub . uncurry (Nano.unify Nano.initInferState)
              , (Nano.list "a", Nano.list (Nano.list "a"))
              , "type error"
              , 2
              , "unify 6" )
  -- 3a tests
  ...
  , fileTest  ( "tests/input/3atest4.hs"
              , Nano.TInt
              , 2 )
  , fileTest  ( "tests/input/3atest5.hs"
              , Nano.TBool
              , 2 )              
  -- 3b tests
