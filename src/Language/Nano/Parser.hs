...
import Text.Megaparsec (Parsec, VisualStream, TraversableStream, ShowErrorComponent, ParseErrorBundle, 
                        (<?>), empty, notFollowedBy, try, choice, sepBy, many, some, between, 
                        eof, runParser, parse, errorBundlePretty)
